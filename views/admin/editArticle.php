<div class="mt-20 mb-20">
    <form class="w-4/5 mx-auto" method="post" action="/admin/update">
        <div class="mb-5">
            ...
            <input type="text" id="Titre" name="titre"
                   ...
                   required
                   value="<?php echo $_SESSION['article']->getTitle() ?>">
        </div>
        <div class="mb-5">
            ...
            <textarea id="content" name="content"
                      ...
                      required><?php echo $_SESSION['article']->getContent() ?></textarea>
        </div>
        <button type="submit"
